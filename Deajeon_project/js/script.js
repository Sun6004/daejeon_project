      ...
      day2: [
        {
          time: "10:00",
          name: "유성온천역 권역",
          desc: "여유롭게 아침을 보내고 숙소에서 체크아웃하며 둘째 날 여행 시작",
          icon: ICONS.tree,
          transport: "차로 약 35~45분",
        },
        {
          time: "10:45",
          name: "대청호자연수변공원",
    ...
    places: [
      {
        ...
        img: "photo-1775883374700-bddbb6c80fcb",
        icon: ICONS.soboro,
      },
      {
        name: "소제동 카페",
        desc: "감성 카페 밀집 골목. 인스타 성지.",
        img: "photo-1641124962413-4eee4dff807e",
        icon: ICONS.coffee,
      },
      {
        name: "중앙시장",
        desc: "두부두루치기, 납작만두, 생선구이.",
        img: "photo-1688115889225-e8e0a23f87da",
        icon: ICONS.market,
      },
      {
        name: "은행동 칼국수",
    ...
    places: [
      {
        ...
        img: "photo-1720271099727-28dc1adfc293",
        icon: ICONS.arboretum,
      },
      {
        name: "계룡산",
      ...
      {
        name: "대청호",
        desc: "드라이브·카약·카페. 물빛이 예뻐요.",
        img: "photo-1542113028-b526238297f1",
        icon: ICONS.drive,
      },
      {
        name: "계족산 황톳길",
  ...
  },
  {
    ...
    places: [
      ...
      },
      {
        ...
        img: "photo-1643051666258-8a4c910c13cf",
        icon: ICONS.artMuseum,
      },
      {
        name: "대전시립박물관",
      ...
      },
      {
        ...
        img: "photo-1762682245610-5aaaf042fdd0",
        icon: ICONS.observatory,
      },
    ],
  },
    ...
    places: [
      {
        ...
        img: "photo-1602884426975-7d8e6d0d720f",
        icon: ICONS.spa,
      },
      {
        name: "두부두루치기",
    ...
    .map((place) => {
      ...
      return `
        ...
        >
          ...
          >
            <img
              src="https://images.unsplash.com/${place.img}?w=320&h=200&fit=crop&auto=format"
              alt="${place.name}"
              draggable="false"
            />

            <div class="famous-icon-badge">
              ${ico(place.icon, 20)}
            </div>
          </div>
