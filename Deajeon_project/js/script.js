...
const COURSE_DATA = {
  자차: {
    미식: {
      day1: [
        { time: "09:00", name: "성심당 본점", desc: "튀김소보로·판타롱부추빵 픽업! 오픈런 추천", icon: ICONS.soboro, transport: "주차 후 도보 5분" },
        { time: "10:30", name: "소제동 카페거리", desc: "철도관사촌 개조 감성 골목, 커피 한 잔 여유", icon: ICONS.coffee, transport: "차로 7분" },
        { time: "12:30", name: "중앙시장", desc: "두부두루치기·납작만두·생선구이 로컬 점심", icon: ICONS.market, transport: "차로 5분" },
        { time: "14:30", name: "은행동 칼국수 골목", desc: "대전식 생칼국수 원조 골목, 얼큰하고 시원해요", icon: ICONS.kalguksu, transport: "도보 10분" },
        { time: "16:30", name: "성심당 DCC점", desc: "여행 마무리 디저트 타임", icon: ICONS.bread, transport: "차로 10분" },
      ],
      day2: [
        { time: "09:30", name: "대흥동 먹자골목", desc: "다양한 로컬 맛집이 모인 골목, 브런치로 시작", icon: ICONS.market, transport: "차로 10분" },
        { time: "11:00", name: "봉명동 로데오거리 카페", desc: "트렌디한 카페거리에서 여유로운 커피 타임", icon: ICONS.coffee, transport: "차로 15분" },
        { time: "13:00", name: "유성시장", desc: "신선한 재료로 만든 백반·전 맛집 거리", icon: ICONS.market, transport: "차로 10분" },
        { time: "15:00", name: "반석동 카페거리", desc: "세련된 브런치 카페들이 모인 골목", icon: ICONS.coffee, transport: "차로 10분" },
        { time: "17:00", name: "대전역 성심당", desc: "기차역 안 성심당에서 여행 마무리 쇼핑", icon: ICONS.train, transport: "차로 15분" },
      ],
    },
    힐링: {
      day1: [
        { time: "08:30", name: "계족산 황톳길", desc: "맨발로 걷는 14.5km 황톳길, 대전 필수 코스!", icon: ICONS.mountain, transport: "차로 20분" },
        { time: "11:00", name: "한밭수목원", desc: "도심 속 100만㎡ 숲, 계절마다 꽃이 피어요", icon: ICONS.arboretum, transport: "차로 25분" },
        { time: "13:30", name: "대청호반 드라이브", desc: "호숫가 카페에서 물멍", icon: ICONS.drive, transport: "차로 30분" },
        { time: "15:30", name: "대전시립미술관", desc: "무료 입장, 여유로운 오후 문화 산책", icon: ICONS.artMuseum, transport: "차로 20분" },
        { time: "17:30", name: "유성온천", desc: "하루 여행 피로를 한 방에", icon: ICONS.spa, transport: "차로 10분" },
      ],
      day2: [
        { time: "09:00", name: "뿌리공원", desc: "효 문화 테마공원, 산책로가 예뻐요", icon: ICONS.tree, transport: "차로 20분" },
        { time: "11:00", name: "식장산 전망대", desc: "대전 시내 파노라마 뷰, 드라이브 코스로 인기", icon: ICONS.observatory, transport: "차로 25분" },
        { time: "13:30", name: "대청댐 물문화관", desc: "호수 전망과 전시 관람, 여유로운 오후", icon: ICONS.lake, transport: "차로 20분" },
        { time: "15:30", name: "만인산자연휴양림", desc: "편백나무 숲속 산책, 피톤치드 가득", icon: ICONS.tree, transport: "차로 30분" },
        { time: "17:30", name: "갑천 은구비다리", desc: "노을 맞으며 산책으로 하루 마무리", icon: ICONS.lake, transport: "차로 15분" },
      ],
    },
    액티비티: {
      day1: [
        { time: "08:00", name: "계룡산 등산", desc: "충청도 명산의 아침 공기! 남매탑 코스 추천", icon: ICONS.mountain, transport: "차로 30분" },
        { time: "11:30", name: "장태산 자연휴양림", desc: "메타세쿼이아 숲속 짚라인, 인생 사진 가득", icon: ICONS.tree, transport: "차로 35분" },
        { time: "13:30", name: "대청호 카약·SUP", desc: "맑은 날 환상적인 물빛 위에서 패들링", icon: ICONS.lake, transport: "차로 25분" },
        { time: "16:00", name: "엑스포과학공원", desc: "1993 세계박람회 부지, 4D영상관까지", icon: ICONS.telescope, transport: "차로 20분" },
        { time: "18:00", name: "갑천 야경 산책", desc: "갑천변 불빛 따라 마무리 산책", icon: ICONS.tower, transport: "차로 10분" },
      ],
      day2: [
        { time: "09:00", name: "대전 오월드", desc: "놀이기구와 동물원이 함께! 짜릿한 하루", icon: ICONS.ticket, transport: "차로 25분" },
        { time: "12:00", name: "갑천 자전거길 라이딩", desc: "시원한 강바람 맞으며 즐기는 라이딩", icon: ICONS.bicycle, transport: "차로 15분" },
        { time: "14:30", name: "유성 스파피아 워터파크", desc: "짜릿한 워터슬라이드로 더위 탈출", icon: ICONS.spa, transport: "차로 15분" },
        { time: "16:30", name: "대동하늘공원", desc: "스카이워크에서 즐기는 짜릿한 전망", icon: ICONS.observatory, transport: "차로 20분" },
        { time: "18:00", name: "성심당 본점", desc: "하루를 마무리하는 달콤한 디저트 타임", icon: ICONS.soboro, transport: "차로 15분" },
      ],
    },
  },
  대중교통: {
    미식: {
      day1: [
        { time: "09:00", name: "성심당 본점", desc: "대전역 도보 10분! 첫 목적지", icon: ICONS.soboro, transport: "대전역 도보 10분" },
        { time: "10:30", name: "대전역 주변 카페", desc: "역 주변 감성 카페, 여유로운 브런치", icon: ICONS.coffee, transport: "도보 5분" },
        { time: "12:00", name: "중앙시장", desc: "로컬 점심의 정수, 두부두루치기 강추!", icon: ICONS.market, transport: "버스 15분" },
        { time: "14:00", name: "소제동 카페거리", desc: "감성 카페·소품숍 골목 산책", icon: ICONS.coffee, transport: "버스 10분" },
        { time: "16:00", name: "은행동 칼국수 골목", desc: "마무리는 역시 칼국수!", icon: ICONS.kalguksu, transport: "버스 8분" },
      ],
      day2: [
        { time: "09:30", name: "봉명동 로데오거리", desc: "지하철 유성온천역 근처 감성 카페거리", icon: ICONS.coffee, transport: "지하철 20분" },
        { time: "11:30", name: "유성시장", desc: "버스로 이동, 로컬 백반·전 맛집 거리", icon: ICONS.market, transport: "버스 15분" },
        { time: "13:30", name: "반석동 카페거리", desc: "버스로 이동, 감성 브런치 카페 골목", icon: ICONS.coffee, transport: "버스 10분" },
        { time: "15:30", name: "대흥동 먹자골목", desc: "버스로 이동, 다양한 맛집 탐방", icon: ICONS.market, transport: "버스 15분" },
        { time: "17:30", name: "대전역 성심당", desc: "지하철로 복귀, 여행 마무리 쇼핑", icon: ICONS.train, transport: "지하철 20분" },
      ],
    },
    힐링: {
      day1: [
        { time: "09:30", name: "한밭수목원", desc: "지하철 정부청사역에서 도보 10분, 도심 숲", icon: ICONS.arboretum, transport: "지하철 15분 + 도보 10분" },
        { time: "11:30", name: "대전시립미술관", desc: "수목원 바로 옆, 무료 기획전 관람", icon: ICONS.artMuseum, transport: "도보 3분" },
        { time: "13:30", name: "보문산 산책로", desc: "버스로 보문산 입구, 전망대까지 가볍게", icon: ICONS.mountain, transport: "버스 20분" },
        { time: "15:30", name: "유성온천", desc: "지하철 유성온천역 하차, 라듐 온천 힐링", icon: ICONS.spa, transport: "지하철 25분" },
        { time: "17:30", name: "갑천 수변 산책", desc: "저녁 바람 맞으며 갑천변 야경 산책", icon: ICONS.lake, transport: "도보 10분" },
      ],
      day2: [
        { time: "09:30", name: "뿌리공원", desc: "버스로 이동, 효 문화 테마공원 산책", icon: ICONS.tree, transport: "버스 25분" },
        { time: "11:30", name: "대청댐 물문화관", desc: "버스로 이동, 호수 전망과 전시 관람", icon: ICONS.lake, transport: "버스 20분" },
        { time: "13:30", name: "대전선사박물관", desc: "버스로 이동, 무료 관람 역사 산책", icon: ICONS.museum, transport: "버스 15분" },
        { time: "15:30", name: "만인산자연휴양림", desc: "버스로 이동, 편백숲 산책", icon: ICONS.tree, transport: "버스 30분" },
        { time: "17:30", name: "갑천 은구비다리", desc: "도보로 노을 맞으며 마무리 산책", icon: ICONS.lake, transport: "도보 10분" },
      ],
    },
    액티비티: {
      day1: [
        { time: "09:00", name: "엑스포과학공원", desc: "지하철 엑스포역, 과학 체험으로 아침 시작!", icon: ICONS.telescope, transport: "지하철 20분" },
        { time: "11:30", name: "대전 O-World", desc: "버스로 이동, 대전 대표 테마파크", icon: ICONS.ticket, transport: "버스 25분" },
        { time: "13:30", name: "대전시립박물관", desc: "버스로 이동, 무료 관람 역사 탐방", icon: ICONS.museum, transport: "버스 20분" },
        { time: "15:30", name: "보문산 전망대", desc: "대전 시내 파노라마 뷰 포인트!", icon: ICONS.observatory, transport: "버스 20분 + 도보 20분" },
        { time: "17:30", name: "대전역 마무리", desc: "성심당 재방문 후 귀가", icon: ICONS.train, transport: "버스 25분" },
      ],
      day2: [
        { time: "09:00", name: "갑천 자전거길 라이딩", desc: "대여소에서 자전거 대여 후 시원한 라이딩", icon: ICONS.bicycle, transport: "버스 15분" },
        { time: "11:30", name: "대동하늘공원", desc: "버스로 이동, 스카이워크 전망대 체험", icon: ICONS.observatory, transport: "버스 20분" },
        { time: "14:00", name: "유성 스파피아 워터파크", desc: "지하철로 이동, 짜릿한 워터슬라이드", icon: ICONS.spa, transport: "지하철 25분" },
        { time: "16:30", name: "한밭수목원", desc: "버스로 이동, 가볍게 산책하며 마무리", icon: ICONS.arboretum, transport: "버스 15분" },
        { time: "18:00", name: "대전역 마무리", desc: "지하철로 복귀, 여행 마무리", icon: ICONS.train, transport: "지하철 20분" },
      ],
    },
  },
};
